...
thai.huynh8324@gmail.com | +84 947 738 943 | Ho Chi Minh City, Vietnam
[LinkedIn](https://www.linkedin.com/in/thaihuynhquang) | [GitHub](https://github.com/thaihuynhquang)
...
### Hipvan Ltd — Singapore

**Senior Mobile Engineer** | Dec 2024 – Present

*Communa by Hipvan & Ohouse Taiwan — Social commerce platform for home inspiration & furnishings*

- Cloned, configured, and launched the **Ohouse Taiwan app** from the Communa codebase, enabling market expansion into Taiwan.
- Migrated and integrated third-party libraries from the JavaScript layer to **iOS & Android native modules**, improving reliability and performance.
- Built a **short-form video feed** feature, enhancing user engagement across both platforms.
...
**Mobile Engineer** | Oct 2022 – Dec 2024
...
**Senior Frontend Engineer** | April 2019 – Dec 2022
...
*Tech stack: ReactJS, NextJS, Ruby on Rails, jQuery, SCSS | Team size: 8*

---

### Rockship — Ho Chi Minh City, Vietnam

**Frontend Team Lead** | May 2018 – April 2019

*Etown — Online Education Platform*

- Developed **HLS video live streaming** and **one-to-one voice call** features using **WebRTC** and Web APIs (MediaRecorder, MediaSource, MediaStream).
- Built **real-time social features** enabling live teacher-student interaction.
- Led **frontend technical architecture** and mentored 3 junior developers.

*Tech stack: ReactJS, SASS - SCSS, WebRTC | Team size: 6*

---

**Frontend Engineer** | Jul 2017 – May 2018

*Zaloex — Cryptocurrency Exchange*

- Implemented new **UI features** for BTC, ETH, and USDT **trading workflows**.
- Contributed to **backend services** including **database schema design** using NodeJS and ExpressJS.

*Tech stack: ReactJS, SCSS, React Native, NodeJS, ExpressJS | Team size: 4*
